...
const STEPS: Step[] = [
    ...
    },
    {
        ...
        detail:
            'Registra ventas, controla el stock de tus productos y mantén un CRM de tus clientes. Recibe alertas cuando el stock esté bajo y ordena a proveedores directamente.',
