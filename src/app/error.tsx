...
export default function GlobalError({
  ...
  return (
    <html lang="es">
      <body style={{ margin: 0, fontFamily: "'Inter', sans-serif", backgroundColor: '#070718', color: '#eef2f7' }}>
        <div
          style={{
            minHeight: '100vh',
            display: 'flex',
            ...
            backgroundImage: 'radial-gradient(ellipse at 20% 20%, rgba(99,102,241,0.15) 0%, transparent 50%), radial-gradient(ellipse at 80% 80%, rgba(139,92,246,0.10) 0%, transparent 40%)',
          }}
        >
          {/* Icon */}
          <div
          ...
          >
            ...
            <a href="mailto:hola@talisto.cl" style={{ color: '#6366f1' }}>
              hola@talisto.cl
            </a>
            .
          </p>
